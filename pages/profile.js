    ...
    return (
        ...
        <div className="px-[24px] lg:px-[50px] py-[40px] ">
            ...
            <div className="my-8 flex items-center justify-center space-x-[90px] lg:space-x-[120px] 2xl:space-x-[130px]">
                ...
                <img onClick={() => { setseletedTab("grid") }} src={seletedTab === "grid" ? "/profile/grid_selected.svg" : "/profile/grid.svg"} alt="" className="object-contain h-[14px] lg:h-[18px]  2xl:h-[20px]" />
                <img onClick={() => { setseletedTab("post") }} src={seletedTab === "post" ? "/profile/post_selected.svg" : "/profile/post.svg"} alt="" className="object-contain h-[14px] lg:h-[18px]  2xl:h-[20px]" />
                <img onClick={() => { setseletedTab("media") }} src={seletedTab === "media" ? "/profile/media_selected.svg" : "/profile/media.svg"} alt="" className="object-contain h-[15px] lg:h-[19px]  2xl:h-[20px]" />
